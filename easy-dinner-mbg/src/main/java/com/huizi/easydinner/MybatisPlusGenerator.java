...
public class MybatisPlusGenerator {
    ...
    public static void main(String[] args) {
        final String url = "jdbc:mysql://124.221.150.33:3306/mall?useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai&useSSL=false";
        ...
        FastAutoGenerator.create(url, user, password)
                .globalConfig(builder -> {
                    builder.author("gw") // 设置作者
                            ...
                            .outputDir(System.getProperty("user.dir") + "/easy-dinner-admin/src/main/java"); // 指定输出目录
                })
                .packageConfig(builder -> {
                    builder.parent("com.huizi.easydinner") // 设置父包名
